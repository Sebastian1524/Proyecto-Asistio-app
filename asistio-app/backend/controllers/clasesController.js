...
exports.obtenerEstudiantes = async (req, res) => {
  try {
    ...
    // Obtener estudiantes (aquí necesitarás una tabla intermedia clase_estudiante)
    // Por ahora, obtendremos todos los estudiantes de la institución
    const resultado = await query(
      `SELECT u.id_usuario, u.nombre, u.primer_apellido, u.segundo_apellido, 
              u.email, u.dni, ui.fecha_de_ingreso_a_la_institucion
       FROM usuario u
